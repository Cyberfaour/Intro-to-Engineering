         ...
         if (keypressed != NO_KEY){
          ...
          if ( keypressed == '*') {
            ...
            if ( keypressed == '*') {
                 ...
                 int countdown = 15; // 60 seconds count down before activating the alarm
                 while (countdown != 0) {
                   lcd.setCursor(13,1);
                   lcd.print(countdown);
                    countdown--;
                    delay(1000);
                     if (countdown <10){ 
                      ...
                      while (activateAlarm == true && alarmActivated==true && activated==true){
                             currentDistance = getDistance() + 100;
